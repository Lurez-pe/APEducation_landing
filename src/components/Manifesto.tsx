      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md rounded-3xl p-8 bg-gradient-to-br from-[#EDE6FB] to-[#FDE3F0] text-[#1C1C42] shadow-lg overflow-hidden border border-[#4705ED]/10">
              <div className="absolute -right-8 -bottom-8 w-40 h-40 bg-[#FE007A]/10 rounded-full blur-2xl pointer-events-none" />
              <div className="flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-deep-teal mb-3">
                <Sparkles className="w-4 h-4" />
                <span>Manifiesto Educativo</span>
              </div>
              <h3 className="font-heading font-extrabold text-2xl sm:text-3xl mb-4 leading-snug text-[#1C1C42]">
              ...
              <div className="space-y-3.5 border-t border-[#4705ED]/10 pt-5">
                <div className="flex items-center gap-3 text-xs sm:text-sm font-semibold text-gray-700">
                  <CheckCircle2 className="w-5 h-5 text-deep-teal flex-shrink-0" />
